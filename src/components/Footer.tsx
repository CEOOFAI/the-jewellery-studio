...
export default function Footer() {
  return (
    <footer className="bg-navy-darkest py-20">
      <div className="max-w-5xl mx-auto flex flex-col items-center px-6">
        {/* Logo */}
        <img
          src="/images/tjs-logo.jpg"
          alt="The Jewellery Studio"
          className="h-[90px] w-auto border-2 border-gold p-2.5 rounded-sm shadow-[0_0_20px_rgba(201,168,76,0.15)] mb-6"
        />

        {/* Tagline */}
        <p className="font-display text-lg italic text-warm/40 mb-4">
          Fine Jewellery &amp; Pawnbrokers
        </p>
        ...
        <div className="flex items-center gap-6 my-6">
          ...
          {/* Facebook */}
          <a
            href="https://www.facebook.com/p/The-Jewellery-Studio-100090502204658/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-muted hover:text-gold transition-colors duration-300"
            aria-label="Facebook"
        ...
        {/* Copyright + Privacy */}
        <p className="font-body text-[10px] text-dim">
          &copy; 2026 The Jewellery Studio. All rights reserved.
        </p>
        <Link
          to="/privacy"
          className="font-body text-[10px] text-dim hover:text-gold transition-colors mt-1"
        >
          Privacy Policy
        </Link>
