...
export default function Shop() {
  ...
  useSEO({
    title: "Shop | The Jewellery Studio",
    description: "Browse our curated collection of fine jewellery, luxury watches, and pre-owned pieces from prestigious houses.",
    url: "/shop",
  });
        ...
        {!loading && filtered.length === 0 && (
          <div className="text-center py-20">
            <div className="mx-auto mb-6 select-none">
              <span className="font-display text-5xl text-navy/10 tracking-wide">
                TJS
              </span>
            </div>
            ...
            <p className="font-body text-sm text-muted mb-8">
              Nothing here yet, but Michael is always sourcing exceptional pieces.
            </p>
            <a
            ...
            >
              ...
              Tell Michael what you're looking for
            </a>
          </div>
        )}
