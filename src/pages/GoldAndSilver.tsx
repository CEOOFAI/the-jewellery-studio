...
const FALLBACK_GOLD: Record<string, number[]> = {
  "1M": [118.50, 120.10, 117.80, 119.50, 121.30],
  "6M": [95.30, 99.50, 103.80, 108.20, 113.40, 118.50, 121.30],
  "1Y": [82.80, 87.40, 91.20, 95.30, 108.20, 118.50, 121.30],
  "5Y": [42.50, 48.80, 55.20, 65.80, 82.30, 121.30],
};

const FALLBACK_SILVER: Record<string, number[]> = {
  "1M": [1.84, 1.88, 1.85, 1.91, 1.94],
  "6M": [1.48, 1.55, 1.61, 1.68, 1.74, 1.84, 1.94],
  "1Y": [1.22, 1.32, 1.40, 1.48, 1.68, 1.84, 1.94],
  "5Y": [0.52, 0.65, 0.78, 0.95, 1.22, 1.94],
};
